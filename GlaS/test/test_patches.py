...
def main():
    ...
    test_dataset = GlaS_Dataset(TEST_IMAGE_DIR, img1_list, train_labels,
                                 transform=transformations)

    test_loader = DataLoader(test_dataset, batch_size=BATCH_SIZE,
                             shuffle=False, drop_last=False, num_workers=4)

    path_train = '../downstream_train/snapshots/diff_quadratic_SSFL_A1_general/8_0.0001_145_0.10451.pth'
