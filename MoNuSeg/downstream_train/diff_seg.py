...
MODEL_TYPE = 'diff_quadratic_SSFL_A1'
...
def main(gpu, args):
    ...
    train_dataset = MoNuSeg_Dataset(TRAIN_IMAGE_DIR,
                                  img1_list[train_index], train_labels[train_index],
                                  transform=transformations)
    eval_dataset = MoNuSeg_Dataset(TRAIN_IMAGE_DIR,
...
if __name__ == '__main__':
    ...
    args['load_from_chkpt'] = '../pretrain/snapshots/diff_quadratic/8_0.0001_84_0.02807.pth'
