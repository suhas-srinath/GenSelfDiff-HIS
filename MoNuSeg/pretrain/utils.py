...
def load_transformed_dataset():
    ...
    train_dataset = MoNuSeg_Dataset(TRAIN_IMAGE_DIR, img1_list[train_index], transform=data_transform)
    eval_dataset = MoNuSeg_Dataset(TRAIN_IMAGE_DIR, img1_list[valid_index], transform=data_transform)
